...
const Appointment = () => {
    ...
    const fetchDocInfo = async () => {
        const docInfo = vendors.find((doc) => doc._id === docId)
        setDocInfo(docInfo)
    }
    ...
    return docInfo ? (
        <div>
            ...
            {/* Listing Releated vendor */}
            <RelatedVendors speciality={docInfo.speciality} docId={docId} />
        </div>
    ) : null
}
