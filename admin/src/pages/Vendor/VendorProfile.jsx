...
const VendorProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(VendorContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/vendor/update-profile', updateData, { headers: { dToken } })
